...
function useDebouncedCallback(callback, options) {
  ...
  const flushRef = (0, import_react6.useRef)(() => {
  });
...
function useCollapse({
  ...
  function getCollapseProps({ style = {}, refKey = "ref", ...rest } = {}) {
    ...
    if (import_react109.default.version.startsWith("18")) {
      if (!opened) {
        props.inert = "";
      }
    } else {
...
var useDelayGroupContext = () => React4.useContext(FloatingDelayGroupContext);
function FloatingDelayGroup(props) {
  ...
  const [state, setState] = React4.useReducer((prev, next) => ({
    ...prev,
    ...next
  }), {
    delay,
  ...
  const initialCurrentIdRef = React4.useRef(null);
  const setCurrentId = React4.useCallback((currentId) => {
    setState({
      currentId
    });
  }, []);
  ...
  return React4.createElement(FloatingDelayGroupContext.Provider, {
    value: React4.useMemo(() => ({
      ...state,
      setState,
      setCurrentId
...
var TextareaAutosize = function TextareaAutosize2(_ref, userRef) {
  ...
  };
  {
    ...
    return React7.createElement("textarea", _extends2({}, props, {
      onChange: handleChange,
      ref
    }));
  }
};
var index3 = React7.forwardRef(TextareaAutosize);
        ...
        children: [
          ...
          (withChildren || rightSection !== void 0) && (0, import_jsx_runtime250.jsx)(
            Box,
            {
              ...
              children: withChildren ? rightSection !== void 0 ? rightSection : (0, import_jsx_runtime250.jsx)(AccordionChevron, { ...getStyles("chevron") }) : rightSection
            }
          )
        ]
      }
...
var RangeSlider = factory((_props, ref) => {
  ...
  return (0, import_jsx_runtime300.jsx)(SliderProvider, { value: { getStyles }, children: (0, import_jsx_runtime300.jsxs)(
    SliderRoot,
    {
      ...others,
      size: size2,
